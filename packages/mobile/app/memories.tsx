        ...
        >
            <View className="mt-4 flex-row items-center justify-between px-8">
                ...
                <View className="flex-row gap-2">
                    ...
                    <TouchableOpacity  className="h-10 w-10 flex items-center justify-center rounded-full bg-red-500" onPress={signOut}>
                        <Icon name="log-out" size={16} color="#000" />
                    </TouchableOpacity>

                    <Link href="/new" asChild>
                        <TouchableOpacity  className="h-10 w-10 flex items-center justify-center rounded-full bg-green-500">
                            ...
                            <View className="space-y-4">
                                ...
                                <Link href="/memories/id" asChild>
                                    <TouchableOpacity className="flex-row items-center gap-2">
                                        ...
                                        <Icon name="arrow-right" size={16} color="#9e93a0" />
                                    </TouchableOpacity>
                                </Link>
                            </View>
                        </View>
